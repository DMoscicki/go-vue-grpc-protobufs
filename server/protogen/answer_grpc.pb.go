...
const (
	TodoService_AddTodo_FullMethodName     = "/protofiles.todoService/addTodo"
	TodoService_DeleteTodo_FullMethodName  = "/protofiles.todoService/deleteTodo"
	TodoService_GetTodos_FullMethodName    = "/protofiles.todoService/getTodos"
	TodoService_LibResponse_FullMethodName = "/protofiles.todoService/libResponse"
	TodoService_GetRepos_FullMethodName    = "/protofiles.todoService/getRepos"
)
...
func (c *todoServiceClient) LibResponse(ctx context.Context, in *Language, opts ...grpc.CallOption) (*LanguageResponse, error) {
	...
	err := c.cc.Invoke(ctx, TodoService_LibResponse_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *todoServiceClient) GetRepos(ctx context.Context, in *GetRepos, opts ...grpc.CallOption) (*LanguageResponse, error) {
	out := new(LanguageResponse)
	err := c.cc.Invoke(ctx, TodoService_GetRepos_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TodoService_LibResponse_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TodoService_LibResponse_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TodoService_GetRepos_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TodoService_GetRepos_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
